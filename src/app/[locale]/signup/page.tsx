...
export default function SignUpPage() {
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center text-white">
      {/* Backgrounds */}
      <video autoPlay loop muted playsInline key="light-video" poster="/auth/atrium-bg-light-poster.jpg" className="dark:hidden fixed inset-0 w-full h-full object-cover -z-10" src="/auth/atrium-bg-light.mp4" />
      <video autoPlay loop muted playsInline key="dark-video" poster="/auth/atrium-bg-dark-poster.jpg" className="hidden dark:block fixed inset-0 w-full h-full object-cover -z-10" src="/auth/atrium-bg-dark.mp4" />
